...
```yaml
system_message: |
  You are `@aem-pr-review-bot` (aka `github-actions[bot]`), a language model
...
tagging it in the comment (`@aem-pr-review-bot`).

Example:

> @aem-pr-review-bot Please generate a test plan for this file.
